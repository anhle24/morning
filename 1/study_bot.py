...
async def fine(interaction: discord.Interaction):
    ...
    while monday <= today:
        ...
        if week_key not in user["weeks_fined"]:
...
@tree.command(name="report", description="Tổng kết điểm danh tuần hiện tại", guild=discord.Object(id=GUILD_ID))
